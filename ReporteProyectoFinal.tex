...
La FPU es un coprocesador dedicado a realizar operaciones con números reales (decimales). A diferencia de los registros generales (EAX, EBX), la FPU utiliza una **pila de registros** de 80 bits (\texttt{ST0} a \texttt{ST7}).
\begin{itemize}
